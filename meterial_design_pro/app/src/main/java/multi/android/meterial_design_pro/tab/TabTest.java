...
import multi.android.meterial_design_pro.exam.ListTestFragment;
import multi.android.meterial_design_pro.exam.ViewFragment1;
import multi.android.meterial_design_pro.exam.ViewFragment3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                //탭을 선택할 때 지정된 프래그먼트 객체가 showe되도록 연결
                getSupportFragmentManager().beginTransaction().
