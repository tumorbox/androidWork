...
public class LocationMapExam2 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public  void getMyLocation(){
        ...
        //이전에 이미 측정했던 값을 가져오고 - 새롭게 측정하는데 시간이 많이 걸릴 수 있으므로
        ...
        //gps모듈이 활성화가 안되어 있으면 newwork_provider로
    ...
    //location 정보를 지도에 셋팅하는 메소드(정보를 받아서 출력하기위해)
    ...
    class MyLocationListener implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            ...
            //리스너 연결 해제 (위치 정보를 한번만 받고 그만 받고 싶을 때)
